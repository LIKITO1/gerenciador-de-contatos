        ...
        <Menu selecionado="register"/>
            <div className="bg-blue-500 w-full h-dvh">
                <form className="w-full p-[8%] flex flex-col gap-10">
                    ...
                    <input type="number" className="border-white border-2 outline-none p-2 w-full rounded-xl"/>
                    </div>
                    <button className="bg-black text-white p-3 rounded-2xl m-auto w-[60%]">Adicionar</button>
                </form>
            </div>
        </>
    )
