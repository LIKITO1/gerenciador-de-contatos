        ...
        <>
            <div className="h-24 text-black bg-white w-full justify-around flex items-center">
                ...
                {menu?(
                    ...
                    <ul className={`bg-linear-to-br from-blue-300 to-blue-500 font-semibold flex flex-col w-full text-white border-black text-center absolute transition-all duration-400 ${menu?"opacity-0 pointer-events-none translate-y-0":"opacity-100 translate-y-33"}`}>
